...
- (void)configCustomNaviBar {
    ...
    _naviBar.alpha = 0.7;
    UILabel *titleLable = [MyControlUIParts createLabelWithFrame:(CGRectMake(0, 0, 150, 44)) Font:17.0f Text:@"图片预览"];
    titleLable.center = CGPointMake(SCREEN_WIDTH / 2, 35);
    titleLable.textColor = [UIColor whiteColor];
    [_naviBar addSubview:titleLable];
    _backButton = [[UIButton alloc] initWithFrame:CGRectMake(10, 15, 44, 44)];
    ...
    _selectButton = [[UIButton alloc] initWithFrame:CGRectMake(self.view.tz_width - 54, 15, 42, 42)];
