...
-(void)setNowCommeNaviGationBar:(NSString *)title andRightbtnImage:(NSString *)rightName andTarget:(id)target SEL:(SEL)method {
    ...
    UIButton *rightBtn = [MyControlUIParts createButtonWithFrame:(CGRectMake(0, 0, 60, 44)) target:target SEL:method title:nil andBG:nil andRadius:0 andTitleColor:commonBlueColor andtitleFont:[UIFont systemFontOfSize:17.0]];
...
- (void)configBottomToolBar {
    ...
    [_okButton setTitleColor:commonBlueColor forState:UIControlStateNormal];
    [_okButton setTitleColor:commonBlueColor forState:UIControlStateDisabled];
